...
bytes, together with the analysis report. Runtime latency is intentionally measured by the host
runner and is not part of the expected analysis annotations.
