...
Platform-agnostic music score library for Rust and WebAssembly (v1.1.3).
...
```toml
acorde = { version = "1.1.3", features = ["abc", "mscz", "mei"] }
```
