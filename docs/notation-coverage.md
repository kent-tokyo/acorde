...
This matrix is versioned with the library. It describes the v0.82.x capability slices and is
...
The matrix applies to v0.82.x. Each `yes` slice must have a fixture or focused round-trip test in
