...
result contains page dimensions, stable page/system addresses, physical measure indices, and
typed break reasons, but does not choose fonts, emit PDF, access printers, or perform filesystem
I/O.
