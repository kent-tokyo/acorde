...
use acorde_render_svg::{render_svg_with_layout, SvgRenderOptions};
...
fn main() {
    ...
    let layout = compute_layout(&score, &LayoutConfig { measures_per_row: 4, ..Default::default() });
    ...
    println!("parts={} measures={} notes={}", score.parts.len(), score.measure_count(), notes);
    println!("layout_us={} render_us={} svg_bytes={}", layout_us, render_us, svg.len());
