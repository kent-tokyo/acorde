...
fn main() {
    ...
    staff.measures.push(measure(
        tuplet_of(vec![q(Step::C, 5), q(Step::D, 5), q(Step::E, 5)], 3, 2),
        4,
        4,
        false,
    ));
    ...
    staff.measures.push(measure(
        tuplet_of(vec![e(Step::C, 5), e(Step::D, 5), e(Step::E, 5)], 3, 2),
        4,
        4,
        true,
    ));
    ...
    staff
        .measures
        .push(measure(tuplet_of(notes, 5, 4), 4, 4, false));

    // measure 4: triplet containing a rest
    staff.measures.push(measure(
        tuplet_of(
            vec![q(Step::C, 5), Note::rest(Duration::Quarter), q(Step::E, 5)],
            3,
            2,
        ),
        4,
