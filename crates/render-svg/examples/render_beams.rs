...
fn e(step: Step, octave: i8) -> Note {
    Note::new(Pitch::new(step, octave), Duration::Eighth)
}
fn s16(step: Step, octave: i8) -> Note {
    Note::new(Pitch::new(step, octave), Duration::Sixteenth)
}
...
fn measure_with_beams(notes: Vec<Note>, num: u8, den: u8) -> Measure {
    ...
    let mut notes = notes;
    for (n, b) in notes.iter_mut().zip(beams) {
        n.beam = b;
    }
...
fn main() {
    ...
    staff.measures.push(measure_with_beams(
        vec![e(Step::C, 5), e(Step::C, 5), e(Step::C, 5), e(Step::C, 5)],
        4,
        4,
    ));
    ...
    staff.measures.push(measure_with_beams(
        vec![e(Step::C, 4), e(Step::D, 5), e(Step::E, 4), e(Step::F, 5)],
        4,
        4,
    ));
    ...
    staff.measures.push(measure_with_beams(
        vec![e(Step::C, 6), e(Step::C, 4), e(Step::C, 6), e(Step::C, 4)],
        4,
        4,
    ));
